...
const Footer = () => {
  return (
    <footer className="bg-gold-antique text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/theearringbar3/" target='_blank' className="text-white hover:text-gold-standard transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/sizing" className="text-white/80 hover:text-white transition-colors">Sizing Guide</Link>
                </li>
                <li>
